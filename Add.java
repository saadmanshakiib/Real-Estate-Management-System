...
public class Add {
    ...
    public Add(String code,String area,String details,String price,String agentname,String email,String contact){
        this.code = code;
        this.area = area;
    ...
    public void addProperty(String code,String area,String details,String price,String agentname,String email,String contact){
    try{
        File file = new File("PropertyFile.txt");
        file.createNewFile();
