...
public class Details1 extends JFrame implements ActionListener, MouseListener {
    ...
    Details1() {
        ...
        c.add(back);
        ImageIcon i = new ImageIcon("images\\b1.png");
        ...
        ae.setText("nissan120438@gmail.com");
        ae.setFont(font2);
        ae.setBounds(120, 280, 610, 40);
        agent.add(ae);

        JLabel ac = new JLabel();
        ac.setText("Contact : 01615828990");
        ac.setFont(font2);
        ac.setBounds(120, 320, 810, 40);
        agent.add(ac);

        JLabel ap = new JLabel();
        ap.setText("Posted on May 3,2024");
        ap.setFont(font2);
        ...
        area.setText("Basundhara R/A, Dhaka , Bangladesh");
        ...
        JLabel t = new JLabel();
        t.setText("Area : 2,410 sq ft");
        t.setBounds(10, 110, 500, 40);
        t.setFont(font2);
        d.add(t);

        JLabel f = new JLabel();
        f.setText("Room : 4 bedrooms,4 bathrooms and 1 kitchen");
        f.setBounds(10, 160, 1000, 40);
        f.setFont(font2);
        d.add(f);

        JLabel a = new JLabel();
        a.setText("Locaton : F block,5 no. road");
        ...
        JLabel o = new JLabel();
        o.setText("Property Code : 57j3N");
        o.setBounds(10, 320, 1000, 40);
        o.setFont(font2);
        d.add(o);
        JLabel price = new JLabel();
        price.setText("Price : 2.2cr");
