...
public class Details2 extends JFrame implements ActionListener, MouseListener {
    ...
    Details2() {
       ...
       // c.add(back);
        ImageIcon i = new ImageIcon("images\\b2.png");
        ...
        ae.setText("tahsinhannan438@gmail.com");
        ae.setFont(font2);
        ae.setBounds(120, 280, 610, 40);
        agent.add(ae);

        JLabel ac = new JLabel();
        ac.setText("Contact : 01829610480");
        ac.setFont(font2);
        ac.setBounds(120, 320, 810, 40);
        agent.add(ac);

        JLabel ap = new JLabel();
        ap.setText("Posted on June 7,2024");
        ap.setFont(font2);
        ...
        area.setText("Jamal khan,Chittagong , Bangladesh");
        ...
        JLabel t = new JLabel();
        t.setText("Area : 1890 sq ft");
        t.setBounds(10, 110, 500, 40);
        t.setFont(font2);
        d.add(t);

        JLabel f = new JLabel();
        f.setText("Room : 3 bedrooms,3 bathrooms and 1 kitchen");
        f.setBounds(10, 160, 1000, 40);
        f.setFont(font2);
        d.add(f);

        JLabel a = new JLabel();
        a.setText("Locaton : A block,5 no. road");
        a.setBounds(10, 210, 1000, 40);
        a.setFont(font2);
        d.add(a);

        JLabel x = new JLabel();
        x.setText("Facilities : Generator,Prepaid Meter etc");
        x.setBounds(10, 270, 1000, 40);
        x.setFont(font2);
        d.add(x);

        JLabel o = new JLabel();
        o.setText("Property Code : a2@3x");
        o.setBounds(10, 320, 1000, 40);
        o.setFont(font2);
        d.add(o);
        JLabel price = new JLabel();
        price.setText("Price : 1.4cr");
