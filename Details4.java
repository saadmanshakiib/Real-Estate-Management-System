...
public class Details4 extends JFrame implements ActionListener, MouseListener {
    ...
    Details4() {
        ...
        ImageIcon i = new ImageIcon("images\\b4.png");
        ...
        area.setText("Tekpara R/A,Cox's Bazar, Bangladesh");
        ...
        JLabel t = new JLabel();
        t.setText("Area : 1780 sq ft");
        t.setBounds(10, 110, 500, 40);
        t.setFont(font2);
        d.add(t);

        JLabel f = new JLabel();
        f.setText("Room : 5 bedrooms,3 bathrooms and 1 kitchen");
        f.setBounds(10, 160, 1000, 40);
        f.setFont(font2);
        d.add(f);

        JLabel a = new JLabel();
        a.setText("Locaton : Z block,15 no. road");
        ...
        JLabel o = new JLabel();
        o.setText("Property Code : ks7da");
        o.setBounds(10, 320, 1000, 40);
        o.setFont(font2);
        d.add(o);
        JLabel price = new JLabel();
        price.setText("Price : 1.50cr");
