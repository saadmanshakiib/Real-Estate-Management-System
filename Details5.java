...
public class Details5 extends JFrame implements ActionListener, MouseListener {
    ...
    Details5() {
        ...
        c.add(back);
        ImageIcon i = new ImageIcon("images\\b5.png");
        ...
        area.setText("Rohanpur, Rajshahi , Bangladesh");
        ...
        JLabel t = new JLabel();
        t.setText("Area : 1410 sq ft");
        t.setBounds(10, 110, 500, 40);
        t.setFont(font2);
        d.add(t);

        JLabel f = new JLabel();
        f.setText("Room : 5 bedrooms,5 bathrooms and 2 kitchen");
        f.setBounds(10, 160, 1000, 40);
        f.setFont(font2);
        d.add(f);

        JLabel a = new JLabel();
        a.setText("Locaton : A block,1 no. road");
        a.setBounds(10, 210, 1000, 40);
        a.setFont(font2);
        d.add(a);

        JLabel x = new JLabel();
        x.setText("Facilities : Generator,Prepaid Meter,Lift");
        x.setBounds(10, 270, 1000, 40);
        x.setFont(font2);
        d.add(x);

        JLabel o = new JLabel();
        o.setText("Property Code : we4r5");
        o.setBounds(10, 320, 1000, 40);
        o.setFont(font2);
        d.add(o);
        JLabel price = new JLabel();
        price.setText("Price : 3.75cr");
