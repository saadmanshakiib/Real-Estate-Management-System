...
public class Sell extends JFrame implements ActionListener{
   ...
   public Sell(){
        ...
        create.setText("ADD A SELL POST"); 
        ...
        ImageIcon houseimage = new ImageIcon("images\\sell.png");
        ...
        signin.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent a){
                if(firstname_tf.getText().isEmpty()==false && number_tf.getText().isEmpty()==false && email_tf.getText().isEmpty()==false && p_tf.getText().isEmpty()==false && pass_tf.getText().isEmpty()==false && confirmpass_tf.getText().isEmpty()==false && contact_tf.getText().isEmpty()==false){
                    ...
                    String area = number_tf.getText();
                    String code = firstname_tf.getText();
                sellf s = new sellf(code, area, details, price, agentname, email, contactp);
                s.sellProperty(code, area, details, price, agentname, email, contactp);
                JOptionPane.showMessageDialog(null,"Sell Post Added");
                newacchomepage a1 = new newacchomepage();
                a1.setVisible(true);
                setVisible(false);
                }
                else{
        ...
        new Add(code,area,details,price,agentname,email,contactp);
        ...
        back.addActionListener(new ActionListener(){
            public void actionPerformed(ActionEvent ae){
                newacchomepage a = new newacchomepage();
                a.setVisible(true);
                setVisible(false);
            }
        });
